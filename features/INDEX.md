...
|----|---------|-------------|--------|------|---------|
| PROJ-1 | Konto & Anmeldung | Registrierung und Login per E-Mail und Passwort; der Ausgabenbereich ist nur angemeldet erreichbar, und jede Person sieht ausschließlich die eigenen Daten. | Tasked | [PROJ-1-accounts-auth](PROJ-1-accounts-auth/) | 2026-08-27 |
